...
import { createDonationCheckoutSession } from '../../services/donations';

interface DonationCheckoutPanelProps {
  amountCents: number;
  onBack?: () => void;
  title?: string;
  subtitle?: string;
...
export function DonationCheckoutPanel({
  amountCents,
  onBack,
  title = 'Complete Your Donation',
  subtitle = 'Enter your payment details below. Your support helps UID Toronto serve our community.',
}: DonationCheckoutPanelProps) {
  ...
  return (
    ...
    >
      ...
      {clientSecret && !error && (
        <div id="embedded-donation-checkout" style={{ minHeight: 'min(400px, 70vh)' }}>
